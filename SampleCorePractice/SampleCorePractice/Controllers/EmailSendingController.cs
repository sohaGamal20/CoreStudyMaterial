...
namespace SampleCorePractice.Controllers
{
    ...
    public class EmailSendingController : ControllerBase
    {
        ...
        public EmailSendingController(IConfiguration configuration, IFluentEmail mailer)
        {
        ...
        public async Task SendEmailwithRazorTemplate()
        {
            //************************************************************************************
            ...
            await Email.From(_configuration.GetValue<string>("Mail:FromEmail"))
             ...
             .To("oha_20@hotmail.com", "Enginer: Soha")
             .Subject("testing Title")
             .SendAsync();
        }
    }
